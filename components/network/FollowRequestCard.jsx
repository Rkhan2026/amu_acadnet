...
const FollowRequestCard = memo(({ request, type, onAction, onViewProfile }) => {
  return (
        ...
        {type === "received" ? (
          <>
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-3 bg-amu-green text-white font-bold rounded-xl hover:shadow-lg hover:shadow-amu-green/20 transition-all text-sm"
            >
              <Check className="h-4 w-4" /> Accept
            </button>
            <button
              onClick={() => onAction(request.id, "reject", "received")}
              className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-50 text-gray-400 font-bold rounded-xl hover:bg-red-50 hover:text-red-500 transition-all text-sm"
            >
          ...
          <button
            ...
            className="w-full py-3 bg-gray-50 text-gray-400 font-bold rounded-xl hover:bg-red-50 hover:text-red-500 transition-all text-sm"
          >
            Cancel Request
          </button>
        )}
