...
export const RESEARCH_PUBLICATIONS = [
  {
    ...
    externalLinks: [
      { label: "GitHub Repository", url: "https://github.com/example/knowledge-graphs" },
      { label: "Project Dissertation", url: "https://example.com/dissertation.pdf" }
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    projectStatus: "Active",
    team: [
      { name: "Dr. Sameer Rizvi", role: "Co-Investigator", avatar: "/placeholder-avatar.svg" },
      { name: "Ammar Siddiqui", role: "Research Assistant", avatar: "/placeholder-avatar.svg" }
    ],
    externalLinks: [
...
export const COLLABORATIONS = [
  ...
  },
  {
    ...
    partners: ["Prof. Sana Fatima", "Dr. Sarah Ahmed"],
    avatar: "/placeholder-avatar.svg",
    status: "Finished",
    progress: 100,
  },
...
export const PENDING_VERIFICATIONS = [
  {
    ...
    status: "Pending",
    avatar: "/placeholder-avatar.svg",
    email: "ammar.siddiqui@myamu.ac.in",
    biography: "Passionate physics researcher focusing on quantum entanglement and its applications in real-world communication systems. Seeking to collaborate with cross-disciplinary teams at AMU.",
  ...
  },
  {
    ...
    status: "Pending",
    avatar: "/placeholder-avatar.svg",
    email: "farah.jafri@amu.ac.in",
    biography: "Historian specializing in medieval architecture and socio-economic structures in Northern India. Dedicated to preserving AMU's rich cultural heritage through extensive research.",
  ...
  },
  {
    ...
    status: "Pending",
    avatar: "/placeholder-avatar.svg",
    email: "zaid.ahmad@amu.ac.in",
    biography: "Assistant Professor researching next-generation micro-electronics and IoT devices. Always open to mentoring driven students and collaborating on innovative electronics projects.",
  ...
  },
  {
    ...
    status: "Pending",
    avatar: "/placeholder-avatar.svg",
    email: "sana.khan.phd@myamu.ac.in",
    biography: "PhD candidate analyzing genetic markers in local flora. Aiming to discover sustainable agricultural practices through deep biological research.",
...
export const PENDING_PUBLICATIONS = [
  {
    ...
    year: 2026,
    submittedAt: "1d ago",
    description: "This project explores the behavior of quantum entangled particles under microgravity conditions using aboard-satellite simulators. The findings are expected to significantly advance our understanding of quantum communication networks for space applications.",
    team: [
      { name: "Zaid Ahmad", role: "Lead Researcher", avatar: "/placeholder-avatar.svg" },
      { name: "Dr. Ayesha Khan", role: "Supervisor", avatar: "/placeholder-avatar.svg" }
    ],
    externalLinks: [
  ...
  },
  {
    ...
    year: 2025,
    submittedAt: "2d ago",
    description: "An in-depth analysis of the historical architecture within the AMU campus and their surrounding socio-economic influences during the medieval era. The study integrates archival research with modern structural assessments.",
    team: [
      { name: "Dr. Farah Jafri", role: "Principal Investigator", avatar: "/placeholder-avatar.svg" }
    ],
    externalLinks: []
  },
  {
    ...
    year: 2026,
    submittedAt: "3d ago",
    description: "Developing novel transformer-based neural network architectures optimized for retrieving highly specific academic papers and institutional datasets, aiming to replace keyword-based search systems with semantic understanding.",
    team: [
      { name: "Ammar Siddiqui", role: "Lead Developer", avatar: "/placeholder-avatar.svg" },
      { name: "Dr. Sarah Ahmed", role: "Co-Investigator", avatar: "/placeholder-avatar.svg" }
    ],
    externalLinks: [
  ...
  },
  {
    ...
    year: 2026,
    submittedAt: "4d ago",
    description: "A comparative experimental study on various new-generation photovoltaic materials under extreme weather conditions typical to the northern Indian climate. The study aims to recommend optimal configurations for future university solar arrays.",
    team: [
      { name: "Sana Khan", role: "Lead Researcher", avatar: "/placeholder-avatar.svg" }
    ],
    externalLinks: [
